-- ---------------------------------------------------------------------
-- Country reference data - Hands on 5 (doc 1)
-- ---------------------------------------------------------------------
...
insert into country (co_code, co_name) values ('CI', 'Côte d');
...
insert into country (co_code, co_name) values ('KP', 'Democratic People');
...
insert into country (co_code, co_name) values ('LA', 'Lao People');
...
-- ---------------------------------------------------------------------
-- Payroll schema sample data - Hands on 3 (doc 2)
-- ---------------------------------------------------------------------
...
insert into employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) values (1, 'Aditi Rao', 72000, true, '1990-04-12', 1);
insert into employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) values (2, 'Rohan Mehta', 68000, true, '1992-11-02', 1);
insert into employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) values (3, 'Kavya Singh', 55000, false, '1996-07-19', 2);
insert into employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) values (4, 'Farhan Ali', 61000, true, '1993-01-27', 2);
insert into employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) values (5, 'Meera Nair', 48000, true, '1998-09-05', 3);
...
-- ---------------------------------------------------------------------
-- Stock sample data - Hands on 2 (doc 2)
-- Rows correspond to the expected-output tables shown in the hands-on doc,
-- so DemoRunner's stock queries reproduce the documented results.
-- ---------------------------------------------------------------------
